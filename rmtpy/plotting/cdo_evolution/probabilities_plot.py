# rmtpy.plotting.cdo_evolution.probabilities_plot.py
...
class ProbabilitiesPlotAxes(PlotAxes):
    # x-axis labels
...
# =======================================
@dataclass(repr=False, eq=False, kw_only=True)
class ProbabilitiesLegend(PlotLegend):
    # Legend location
    loc: str = "upper right"
...
# =======================================
# 4. Probabilities Plot Dataclass
# =======================================
@dataclass(repr=False, eq=False, kw_only=True)
class ProbabilitiesPlot(Plot):
    # Unfolded data flag
    unfold: bool = False
    ...
    # Other probability curve parameters
    p1_color: str = "Red"
    p1_alpha: float = 1.0
    p1_width: float = 1.0
    p1_zorder: int = 2
    ...
    # Axes configuration
    axes: ProbabilitiesPlotAxes = field(default_factory=ProbabilitiesPlotAxes)

    def __post_init__(self):
        # Initialize base class
        super(ProbabilitiesPlot, self).__post_init__()
        ...
        self.legend = ProbabilitiesLegend(handles=self.handles, labels=self.labels)
    ...
    def plot(self):
        """Creates a plot of various CDO probabilities and saves it to a file."""
